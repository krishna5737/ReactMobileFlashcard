...
import { getTimeToString, dailyReminderMessage, removeNotification, setLocalNotification } from '../utils/helpers'
      ...
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        {
          quizEnd === true
            ? <View style={styles.container}>
                <Text style={{fontSize: 40}}>Quiz completed</Text>
                <Text style={{fontSize: 20}}>Correct: {correct}</Text>
                <Text style={{fontSize: 20}}>Incorrect: {incorrect}</Text>
            ...
            : deck.cards === undefined || deck.cards.length === 0
              ...
              : <View style={styles.container}>
                  ...
                  <TouchableOpacity style={styles.correctOptionBtn}
                    onPress={this.handleCorrect}>
                    <Text style={styles.btnText}>Correct</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.incorrectOptionBtn}
